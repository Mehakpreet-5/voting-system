...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        ...
        fetch("https://voting-system-6zk3.onrender.com/api/voters")
            .then(res => res.json())
    ...
    const deleteCandidate = async (id) => {
        ...
        await fetch(`https://voting-system-6zk3.onrender.com/api/candidates/${id}`, {
            method: "DELETE"
        })
    ...
    const addCandidate = async (e) => {
        ...
        const res = await fetch("https://voting-system-6zk3.onrender.com/api/candidates", {
            method: "POST",
            headers: {
