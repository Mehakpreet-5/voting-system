...
//   return (
//     <div className="flex bg-slate-950 min-h-screen text-white text-base">
...
//           <div className="bg-slate-900 p-6 rounded-xl border border-purple-500 shadow-[0_0_25px_rgba(168,85,247,0.7)]">
...
//           <div className="flex-1 bg-slate-900 p-6 rounded-xl border border-purple-500 shadow-[0_0_25px_rgba(168,85,247,0.6)]">

//             <h2 className="text-xl mb-4">Vote Details</h2>
...
//           <div className="w-full lg:w-1/2 bg-slate-900 p-6 rounded-xl border border-purple-500 h-96 shadow-[0_0_25px_rgba(168,85,247,0.6)]">
