...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await fetch("https://voting-system-6zk3.onrender.com/api/auth/login", {
        method: "POST",
        headers: {
        ...
        setTimeout(async () => {
          try {
            const voteRes = await fetch(
              `https://voting-system-6zk3.onrender.com/api/check?email=${encodeURIComponent(email)}`
            );
